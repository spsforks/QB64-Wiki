...
**[Download of 32 and 64 bit versions of INPOUT](http://www.highrez.co.uk/scripts/download.asp?package=InpOutBinaries)**
...
![Screenshot of demo without a printer on the port](http://i301.photobucket.com/albums/nn53/burger2227/Inpout32.gif)
...
>  **DO NOT RUN HIGH CURRENT DEVICES with the 5 volt DC output! Use [opto-isolators!](http://en.wikipedia.org/wiki/Opto-isolator) with a separate power supply.**
